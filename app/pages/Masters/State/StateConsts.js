...
export const NAMESPACE_COUNTRY = 'country';
export const NAME_COUNTRY_LABEL = 'Country';
export const NAME_COUNTRY_PLACEHOLDER = 'Please Select Country';

export const PAGE_TITLE = 'State';
export const PAGE_TITLE_TAGLINE = 'State master details - for MMS';
export const FORM_ID = 'StateForm';
export const NOTIFICATION_TITLE = 'State Master';
...
export const POPCONFIRM_TITLE = 'Are you sure to delete this State ?';
...
export const COLUMN_NAME = 'State';
