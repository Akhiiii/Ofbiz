...
export const PAGE_TITLE = 'Country';
export const PAGE_TITLE_TAGLINE = 'Country master details - for MMS';
export const FORM_ID = 'CountryForm';
export const NOTIFICATION_TITLE = 'Country Master';
...
export const POPCONFIRM_TITLE = 'Are you sure to delete this Country ?';
...
export const COLUMN_NAME = 'Country';
