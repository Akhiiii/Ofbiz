// Page Configs
export const NAMESPACE = 'commentType';

export const PAGE_TITLE = 'CommentType';
export const PAGE_TITLE_TAGLINE = 'CommentType master details - for MMS';
export const FORM_ID = 'CommentTypeForm';
export const NOTIFICATION_TITLE = 'CommentType Master';
...
export const NAME_LABEL = 'Type';
export const ID_LABEL = 'Id';
export const ID_PLACEHOLDER = 'Enter Id';
export const NAME_PLACEHOLDER = 'Enter Type';
export const NAME_REQUIRED = true;
export const NAME_ERROR_MSG_REQUIRED = 'Type Name is mandatory.';
...
export const POPCONFIRM_TITLE = 'Are you sure to delete this CommentType ?';
...
export const COLUMN_NAME = 'CommentType';
