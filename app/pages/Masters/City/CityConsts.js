...
export const PAGE_TITLE = 'City';
export const PAGE_TITLE_TAGLINE = 'City master details - for MMS';
export const FORM_ID = 'CityForm';
export const NOTIFICATION_TITLE = 'City Master';
...
export const STATE_NAME_LABEL = 'State';
export const STATE_NAME_PLACEHOLDER = 'Please Select Country';
export const COUNTRY_NAME_LABEL = 'Country';
export const COUNTRY_NAME_PLACEHOLDER = 'Please Select Country';
...
export const POPCONFIRM_TITLE = 'Are you sure to delete this City ?';
