...
export default {
  ...
  effects: {
    ...
    *actionSaveall({ payload }, { call, put }) {
      const response = yield call(serviceSaveall, payload);
      yield put({
        type: 'reducerSaveall',
        payload: response.data || [],
      });
    ...
    *actionstatesByCountryList({ payload }, { call, put }) {
      const response = yield call(servicestatesByCountryList, payload);
      yield put({
        type: 'reducerstatesByCountryList',
        payload: response.data || [],
      });
      return response.data || [];
    },
  ...
  reducers: {
    ...
    reducerstatesByCountryList(state, action) {
      return {
        ...state,
        reducerstatesByCountryList: action.payload,
      };
    },
  },
};
