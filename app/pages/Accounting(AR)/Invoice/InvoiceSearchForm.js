...
import { Row, Col, Button, Form, Input, Icon, Select,Tag ,Table ,Checkbox, DatePicker,Drawer,Popover } from 'antd';
          ...
          <Col span={7}>
            <FormItem label={localConsts.BillingAccountID_LABEL}>
              {getFieldDecorator('BillingAccountID', {
                ...
                <Input  placeholder={localConsts.BillingAccountID_LABEL} name="BillingAccountID" addonAfter={<Icon  type="idcard" onClick={this.showDrawer1} />} />
              )}
            </FormItem>
          </Col>
          <Col span={7}>
          ...
          <Col span={7}>
            <FormItem label={localConsts.InvoiceID_LABEL}>
              {getFieldDecorator('InvoiceID', {
                ...
                <Input  placeholder={localConsts.InvoiceID_PLACEHOLDER}
                addonBefore={(
