...
class TitlePane extends React.PureComponent {
  ...
  render() {
    ...
    if (currentAction === 'close') {
      ...
      pageTitleValue = `${pageTitleObject.pageTitle}`;
    ...
    return (
      <Row>
        ...
        {pageTitleValue != 'Reports' && <Col span={12} className={styles.menu}>
          <ButtonGroup>
            <ActionButtonMenu
